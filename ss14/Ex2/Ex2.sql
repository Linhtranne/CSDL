...
BEGIN
    ...
    VALUES (OLD.employee_id, (SELECT base_salary FROM salaries WHERE employee_id = OLD.employee_id), NULL, NOW(), 'Nhân viên bị xóa');
END//
DELIMITER ;
...
INSERT INTO employees (name, email, phone, hire_date, department_id)
VALUES ('Trần Thị C', 'tranthic@company.com', '0912345678', '2024-02-17', 2);
